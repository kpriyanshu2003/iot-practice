...
import SignU from "./subComponents/signup-uno";
import SignD from "./subComponents/signup-dos";
import SignT from "./subComponents/signup-tres";
...
export default function Auth() {
  ...
  const update = (n) => {
    if (n === "lgn") setCurr(<Login dos={dos} update={update} />);
    else if (n === "sgn-U") setCurr(<SignU dos={dos} update={update} />);
    else if (n === "sgn-D") setCurr(<SignD dos={dos} update={update} />);
    else if (n === "sgn-T") setCurr(<SignT dos={dos} update={update} />);
    else if (n === "sgn-Cu") setCurr(<SignCu dos={dos} update={update} />);
    else console.log("Error Occured");
  };

  const [curr, setCurr] = useState(<SignCu dos={dos} update={update} />);
