...
export default function Dashboard() {
  ...
  return (
    <Fragment>
      <div className="absolute h-full w-24 font-raleway">
        <div className="w-full flex justify-center mt-4">
          <img src={dashicon} alt="" />
        </div>
        <div className="absolute w-full h-full grid grid-cols-1 grid-rows-6 col-span-1 place-items-center shadow-2xl">
          <div
            className=" cursor-pointer"
            onClick={() =>
              current.num === 0 ? "" : setCurrent({ page: <Home />, num: 0 })
            }
          >
            <svg
              width="32"
            ...
            >
              <path
                d="M17.6032 3.82079C17.1627 3.425 16.5914 3.20605 15.9993 3.20605C15.4071 3.20605 14.8358 3.425 14.3952 3.82079L5.59525 11.728C5.34505 11.953 5.14495 12.2281 5.00796 12.5354C4.87096 12.8428 4.80013 13.1755 4.80005 13.512V24.8C4.80005 25.4365 5.05291 26.047 5.50299 26.497C5.95308 26.9471 6.56353 27.2 7.20005 27.2H10.4C11.0366 27.2 11.647 26.9471 12.0971 26.497C12.5472 26.047 12.8 25.4365 12.8 24.8V18.4C12.8 18.1878 12.8843 17.9843 13.0344 17.8343C13.1844 17.6843 13.3879 17.6 13.6 17.6H18.4001C18.6122 17.6 18.8157 17.6843 18.9657 17.8343C19.1158 17.9843 19.2001 18.1878 19.2001 18.4V24.8C19.2001 25.4365 19.4529 26.047 19.903 26.497C20.3531 26.9471 20.9635 27.2 21.6001 27.2H24.8001C25.4366 27.2 26.047 26.9471 26.4971 26.497C26.9472 26.047 27.2001 25.4365 27.2001 24.8V13.512C27.2 13.1755 27.1291 12.8428 26.9921 12.5354C26.8551 12.2281 26.6551 11.953 26.4049 11.728L17.6049 3.82079H17.6032Z"
                fill={current.num === 0 ? "#BF13BF" : "#DBD3EB"}
              />
            </svg>
          </div>
          <div
            ...
            onClick={() =>
              current.num === 1
                ? ""
                : setCurrent({ page: <Transaction />, num: 1 })
            }
          >
            <svg
              width="32"
            ...
            >
              <path
                d="M26.756 8.25685C26.8954 8.37148 27.0076 8.51561 27.0845 8.67886C27.1614 8.84211 27.2011 9.02039 27.2008 9.20085C27.2017 9.35783 27.171 9.51339 27.1105 9.65825C27.0501 9.80311 26.9611 9.93432 26.8488 10.0441L22.036 14.8505C21.811 15.0752 21.506 15.2014 21.188 15.2014C20.87 15.2014 20.565 15.0752 20.34 14.8505C20.2283 14.7393 20.1398 14.6071 20.0793 14.4616C20.0188 14.3161 19.9877 14.16 19.9877 14.0025C19.9877 13.8449 20.0188 13.6888 20.0793 13.5433C20.1398 13.3978 20.2283 13.2657 20.34 13.1545L23.1112 10.4009H6.0008C5.68254 10.4009 5.37732 10.2744 5.15227 10.0494C4.92723 9.82434 4.8008 9.51911 4.8008 9.20085C4.8008 8.88259 4.92723 8.57737 5.15227 8.35233C5.37732 8.12728 5.68254 8.00085 6.0008 8.00085H23.0952L20.3464 5.24565C20.235 5.13448 20.1466 5.00243 20.0863 4.85706C20.026 4.71168 19.9949
.1844 17.6843 21.0344 17.8344C20.8843 17.9844 20.8001 18.1879 20.8001 18.4001C20.8001 18.6122 20.8843 18.8157 21.0344 18.9657C21.1844 19.1158 21.3879 19.2001 21.6 19.2001H23.2001C23.4122 19.2001 23.6157 19.1158 23.7657 18.9657C23.9158 18.8157 24 18.6122 24 18.4001C24 18.1879 23.9158 17.9844 23.7657 17.8344C23.6157 17.6843 23.4122 17.6 23.2001 17.6Z"
                fill={current.num === 2 ? "#BF13BF" : "#DBD3EB"}
              />
            </svg>
          </div>
          <div
          ...
          >
            ...
            >
              <path
                d="M16 3.19995C14.3027 3.19995 12.6748 3.87424 11.4746 5.07447C10.2743 6.2747 9.60005 7.90257 9.60005 9.59995C9.60005 11.2973 10.2743 12.9252 11.4746 14.1254C12.6748 15.3257 14.3027 16 16 16C17.6974 16 19.3253 15.3257 20.5255 14.1254C21.7258 12.9252 22.4001 11.2973 22.4001 9.59995C22.4001 7.90257 21.7258 6.2747 20.5255 5.07447C19.3253 3.87424 17.6974 3.19995 16 3.19995ZM8.01445 17.6C7.59307 17.5983 7.1755 17.6798 6.78569 17.8398C6.39588 17.9999 6.0415 18.2353 5.74286 18.5326C5.44423 18.8299 5.20722 19.1832 5.04543 19.5723C4.88365 19.9614 4.80026 20.3786 4.80005 20.7999C4.80005 23.5056 6.13285 25.5456 8.21605 26.8752C10.2672 28.1824 13.032 28.7999 16 28.7999C18.9681 28.7999 21.7328 28.1824 23.784 26.8752C25.8673 25.5472 27.2001 23.504 27.2001 20.7999C27.2001 19.9513 26.8629 19.1373 26.2628 18.5372C25.6627 17.9371 24.8487 17.6 24 17.6H8.01445Z"
                fill={current.num === 3 ? "#BF13BF" : "#DBD3EB"}
              />
            </svg>
          </div>
          <div
          ...
          >
            ...
            >
              <path
                d="M19.9199 25.6032C19.7363 26.5074 19.2457 27.3203 18.5313 27.9043C17.8169 28.4882 16.9226 28.8072 15.9999 28.8072C15.0772 28.8072 14.1829 28.4882 13.4685 27.9043C12.7541 27.3203 12.2635 26.5074 12.0799 25.6032H19.9199ZM15.9967 3.19995C21.0351 3.19995 25.1871 6.93595 25.5711 11.768L25.5919 12.1248L25.5999 12.4832L25.5983 18.2528L27.1247 22.392L27.1647 22.528L27.1903 22.6656L27.1983 22.808C27.1983 23.312 26.8847 23.752 26.3631 23.9392L26.1807 23.992L25.9983 24.008H6.00152C5.86003 24.0075 5.71974 23.9821 5.58712 23.9328C5.12792 23.7648 4.82552 23.3376 4.81592 22.7872L4.82232 22.6L4.87672 22.392L6.39672 18.2576L6.39992 12.4688L6.40632 12.1088C6.60312 7.12155 10.8335 3.19995 15.9967 3.19995Z"
                fill={current.num === 4 ? "#BF13BF" : "#DBD3EB"}
              />
            </svg>
          </div>
        </div>
      </div>
      <div className="h-screen absolute left-36 top-10">{current.page}</div>
    </Fragment>
  );
}
