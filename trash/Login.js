...
export default function Auth() {
  return (
    <div className="flex mt-24 justify-evenly items-center font-raleway">
      <div className="-ml-10">
        <span className="font-semibold text-2xl">Hey!</span>
        <br />
        <span className="font-bold text-3xl">Welcome back.</span>
        <br />
        <img src={login} alt="Login Icon" className="mt-14" />
      </div>

      <div className="bg-gray-200 h-80 w-0.5 "></div>

      <div className="">
        <img src={logo} alt="Logo" className="mb-10" />
        <br />
        <span className="font-semibold text-2xl">Login to your account</span>
        <br />
        <br />
        ...
        <br />
        <div className="mt-5">
          <span className="font-normal">Forgot Password? </span>
          <span className="uppercase text-[#BF13BF] font-medium">
            Reset Password
          </span>
          <br />
          <span className="font-normal">Don't have account? </span>
          <span className="uppercase text-[#BF13BF] font-medium">Sign Up</span>
        </div>
      </div>
    </div>
  );
