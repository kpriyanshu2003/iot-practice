...
import phimg from "../images/signup-ph.svg";
  ...
  return (
    <div>
      <div>
        ...
        <span>Welcome.</span>
        <br />
        <img src={phimg} alt="Basic Icon" />
      </div>
      <div></div>
      <div>
        <img src={logo} alt="Logo" />
        <br />
        <span>Sign up to vep</span>
        <br />
        <span>Enter your phone number to register with your account.</span>
        <br />
        <div>
